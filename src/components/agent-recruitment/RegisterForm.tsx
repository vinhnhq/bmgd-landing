		...
		<Container className="bg-white px-28 my-16">
			...
			<div className="w-full bg-[#FF3B3B]/[0.42] relative">
				...
				<Image
					...
					className="absolute inset-0 w-full h-full object-cover mix-blend-lighten rounded-[10px]"
				/>
							...
							<>
								...
								<Form {...form}>
									<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
										...
										<button
											type="submit"
											className="h-12 bg-[#F24444] text-white
												rounded-md shadow-elevation hover:scale-105 px-6
